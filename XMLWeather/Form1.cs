...
namespace XMLWeather
{
    public partial class Form1 : Form
    {
        ...
        public static string searchPlace = "Stratford,CA";
        ...
        {
            XmlReader reader = XmlReader.Create("http://api.openweathermap.org/data/2.5/forecast/daily?q=" + searchPlace + "&mode=xml&units=metric&cnt=7&appid=3f2e224b815c0ed45524322e145149f0");
        ...
        public static void ExtractCurrent()
        {
            ...
            XmlReader reader = XmlReader.Create("http://api.openweathermap.org/data/2.5/weather?q=" + searchPlace + "&mode=xml&units=metric&appid=3f2e224b815c0ed45524322e145149f0");
